-- ============================================================
-- PRACTICA 05
-- CARGAR DATOS BD NEGOCIOS - POSTGRESQL
-- ============================================================


-- ============================================================
-- 1. ELIMINAR REGISTROS EXISTENTES
-- Se eliminan respetando las llaves foráneas
-- ============================================================
...
-- ============================================================
-- 2. REINICIAR LOS IDENTITY
-- Para que id_venta e id_detalle comiencen nuevamente en 1
-- ============================================================

ALTER TABLE ventas
    ALTER COLUMN id_venta RESTART WITH 1;

ALTER TABLE detalle_ventas
    ALTER COLUMN id_detalle RESTART WITH 1;
...
VALUES
    ('CLI0000000001', 'Ana Martinez',
     '6181000001', 'ana@email.com', 'Durango, Dgo.'),

    ('CLI0000000002', 'Carlos Ramirez',
     '6181000002', 'carlos@email.com', 'Durango, Dgo.'),

    ('CLI0000000003', 'Laura Hernandez',
     '6181000003', 'laura@email.com', 'Gomez Palacio, Dgo.'),

    ('CLI0000000004', 'Jose Rodriguez',
     '6181000004', 'jose@email.com', 'Lerdo, Dgo.'),

    ('CLI0000000005', 'Maria Lopez',
     '6181000005', 'maria@email.com', 'Durango, Dgo.');
...
VALUES
    ('PROD0000000000000001',
     'Teclado',
     'Teclado USB',
     350.00,
     50),

    ('PROD0000000000000002',
     'Mouse',
     'Mouse optico USB',
     200.00,
     60),

    ('PROD0000000000000003',
     'Monitor',
     'Monitor LED 24 pulgadas',
     3200.00,
     20),

    ('PROD0000000000000004',
     'Memoria USB',
     'Memoria USB 64 GB',
     250.00,
     100),

    ('PROD0000000000000005',
     'Audifonos',
...
-- ============================================================
-- 5. INSERTAR VENTAS
-- El total inicialmente se registra en cero
-- ============================================================
...
-- ============================================================
-- 6. INSERTAR DETALLE DE LAS VENTAS
...
-- ============================================================
-- 7. CALCULAR EL TOTAL DE CADA VENTA
...
-- ============================================================
-- 9. VERIFICAR INTEGRIDAD DE LOS TOTALES
